...
import (
	...
	testdata "github.com/chsir-zy/anan/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/chsir-zy/anan/framework/gin.handlerNameTest$", c.HandlerName())
}
